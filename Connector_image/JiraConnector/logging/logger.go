...
func NewLogger() *Logger {
	...
	logs, _ := os.OpenFile("/usr/src/connector/logs/logs.log", os.O_APPEND|os.O_WRONLY, os.ModeAppend)
	errors, _ := os.OpenFile("/usr/src/connector/logs/err_logs.log", os.O_APPEND|os.O_WRONLY, os.ModeAppend)
